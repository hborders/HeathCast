...
public class EpisodeTableTest extends AbstractDatabaseTest<Object> {
    ...
    @Test
    public void testObserveQueryForEpisodeIdentifiedListVersionedOptionalForPodcast() throws Exception {
        final PodcastImpl podcast = new PodcastImpl(
                new URL("http://example.com/artwork"),
                "author",
                new URL("http://example.com/feed"),
        ...
        final MatcherTestObserver<
                ...
                > episodeIdentifiedListVersionedOptionalTestObserver = new MatcherTestObserver<>();
        getTestObject()
                .observeQueryForEpisodeIdentifiedListVersionedOptionalForPodcast(podcastIdentifier)
                .subscribe(episodeIdentifiedListVersionedOptionalTestObserver);

...
public final class PodcastIdentifiedsList implements List<Identified<Podcast>> {
    private final List<Identified<Podcast>> podcastIdentifieds;

    public PodcastIdentifiedsList(List<Identified<Podcast>> podcastIdentifieds) {
    ...
    public boolean equals(@Nullable Object o) {
        return podcastIdentifieds.equals(o);
    }

    @Override
    public int hashCode() {
        return podcastIdentifieds.hashCode();
    }
